...
export default function SideMenu({ isOpen, onClose }: SideMenuProps) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className={`absolute inset-0 z-40 transition-opacity duration-500 ease-in-out ${
      ...
      {/* Side Menu */}
      <div
        className={`absolute left-0 top-0 h-full w-80 bg-white z-50 shadow-2xl transform transition-all duration-500 ease-in-out ${
