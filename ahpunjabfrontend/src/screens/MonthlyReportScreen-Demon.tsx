...
export default function MonthlyReportScreen() {
  ...
  return (
    <div className="MonthlyReportScreen relative w-full h-screen max-w-md mx-auto bg-white flex flex-col overflow-hidden">
      {/* Header */}
      <MainHeader
        ...
        <div className="mt-6 bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <p className="text-xs text-yellow-900 font-['Poppins'] leading-relaxed">
              <span className="font-semibold">Need a copy?</span> Tap the download icon next to any submitted or approved report to save it as a PDF.
            </p>
          </div>
        </div>
