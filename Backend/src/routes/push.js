...
export default async function pushRoutes(fastify, options) {
  ...
  fastify.post('/subscribe', {
    ...
    schema: {
      description: 'Subscribe to push notifications (requires JWT)',
      tags: ['push'],
      security: [{ bearerAuth: [] }],
      body: {
        type: 'object',
  ...
  fastify.post('/unsubscribe', {
    ...
    schema: {
      description: 'Unsubscribe from push notifications (requires JWT)',
      tags: ['push'],
      security: [{ bearerAuth: [] }],
      body: {
        type: 'object',
  ...
  // Send test push notification (requires authentication)
  fastify.post('/test', {
    preHandler: authenticate,
    config: {
      rateLimit: {
    ...
    schema: {
      description: 'Send test push notification (requires JWT)',
      tags: ['push'],
      security: [{ bearerAuth: [] }],
      response: {
        200: {
