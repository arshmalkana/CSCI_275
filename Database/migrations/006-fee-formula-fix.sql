...
-- ============================================================================
-- 1. Correct service charge rates to match the ₹62,425 regression anchor
-- ============================================================================
...
-- AI rates: these match the COALESCE fallback values baked into get_fee_summary
-- (ETT=35, IMP=50, SEXED=200, BUFFALO=25, PM_LARGE=100)
UPDATE service_charges SET current_rate =  35.00 WHERE service_code = 'AI_COW_ETT';
UPDATE service_charges SET current_rate =  50.00 WHERE service_code = 'AI_COW_IMP';
UPDATE service_charges SET current_rate = 200.00 WHERE service_code = 'AI_COW_SEXED';
UPDATE service_charges SET current_rate =  25.00 WHERE service_code = 'AI_BUFFALO';
UPDATE service_charges SET current_rate = 100.00 WHERE service_code = 'PM_LARGE';
