...
('SWINE_FEVER', 'Swine Fever', NULL),
('GOAT_POX', 'Goat Pox', NULL),
('PPR', 'Peste des Petits Ruminants', NULL)
...
INSERT INTO institute_targets (
    ...
    (NULL, 'CVH', 'Vaccine', (SELECT vaccine_id FROM vaccines WHERE vaccine_code = 'BRUC'), 3500, 292, '2025-04-01', NULL, '2025-26',
     'CVH Brucellosis vaccine default', (SELECT staff_id FROM staff WHERE user_id = 'test')),
    (NULL, 'CVH', 'Vaccine', (SELECT vaccine_id FROM vaccines WHERE vaccine_code = 'THEI'), 3800, 317, '2025-04-01', NULL, '2025-26',
    ...
    (NULL, 'CVD', 'Vaccine', (SELECT vaccine_id FROM vaccines WHERE vaccine_code = 'BRUC'), 2000, 167, '2025-04-01', NULL, '2025-26',
     'CVD Brucellosis vaccine default', (SELECT staff_id FROM staff WHERE user_id = 'test')),
    (NULL, 'CVD', 'Vaccine', (SELECT vaccine_id FROM vaccines WHERE vaccine_code = 'THEI'), 2100, 175, '2025-04-01', NULL, '2025-26',
    ...
    ((SELECT institute_id FROM institutes WHERE org_id = 'TEST001'), NULL, 'Vaccine', (SELECT vaccine_id FROM vaccines WHERE vaccine_code = 'BRUC'), 2500, 208, '2025-04-01', NULL, '2025-26',
     'TEST001 specific: Brucellosis vaccine target', (SELECT staff_id FROM staff WHERE user_id = 'test')),
    ((SELECT institute_id FROM institutes WHERE org_id = 'TEST001'), NULL, 'Vaccine', (SELECT vaccine_id FROM vaccines WHERE vaccine_code = 'THEI'), 2600, 217, '2025-04-01', NULL, '2025-26',
